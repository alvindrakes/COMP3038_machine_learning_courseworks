...
C_value = [0.05, 0.5, 1.0, 5.0, 10.0, 50.0,100.0, 250.0, 500.0, 750.0];
KernelScale = [0.05, 0.5, 1.0, 5.0, 10.0, 50.0,100.0, 250.0, 500.0, 750.0];
...
for i = 1:length(C_value)
    ...
    for j =1:length(KernelScale)
        ...
        for m =1:k
            ...
            SVM = fitcsvm(training_input,training_target, 'KernelFunction','rbf', 'BoxConstraint',C_value(i),...
            'KernelScale',KernelScale(j),'Standardize', true);
...
for i =1:k
    ...
    SVM = fitcsvm(training_input,training_target, 'KernelFunction','rbf', 'BoxConstraint',bestHP.C_value,...
            'KernelScale', bestHP.KernelScale,'Standardize', true);
