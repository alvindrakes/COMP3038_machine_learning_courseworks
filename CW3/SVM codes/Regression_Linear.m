...
for l =1:length(epsilon)
    ...
    for m =1:k
        ...
        SVM = fitrsvm(training_input, training_target,'KernelFunction', 'linear',...
        'BoxConstraint', 1, 'Epsilon', epsilon(l),'Standardize', true );
...
for i =1:k
    ...
    SVM = fitrsvm(training_input, training_target,'KernelFunction', 'linear',...
            'BoxConstraint', 1, 'Epsilon', bestHP.epsilon,'Standardize', true );
